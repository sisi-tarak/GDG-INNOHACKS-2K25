      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            transform into impactful solutions. Hosted within our college,
            this hackathon is not just an event—it's an innovation movement
            designed to push the boundaries of technological advancements.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-12">
          <div className="p-8 rounded-lg shadow-md">
            ...
            <p className="text-gray-300 mb-4">
              ...
              participants are challenged to think beyond conventional
              limits.
            </p>
            <div className="mt-6">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="text-headStrong mr-2">🌎</span>
                ...
                <li className="flex items-start">
                  <span className="text-headStrong mr-2">🎁</span>
                  <span className="text-gray-300">
                    <strong>Exciting prizes</strong> and career
                    opportunities.
                  </span>
                </li>
              </ul>
          ...
          <div className="p-8 rounded-lg shadow-md">
            ...
            <p className="text-gray-300 mb-4">
              GDG Innohacks is more than just a competition—it's a
              launchpad for future innovators. It bridges the gap between
              theoretical knowledge and practical implementation by
              offering:
            </p>
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
                <span className="text-headStrong font-bold mr-2">•</span>
                <div>
              ...
              <li className="flex items-start">
                <span className="text-headStrong font-bold mr-2">•</span>
                <div>
                  <strong>Collaboration with Industry Experts</strong> –
                  Gaining insights from professionals.
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-headStrong font-bold mr-2">•</span>
                <div>
                  <strong>Tech for a Better Future</strong> – Solutions
                  focused on sustainability, AI, and automation.
                </div>
              </li>
              <li className="flex items-start">
                <span className="text-headStrong font-bold mr-2">•</span>
                <div>
                  <strong>Career & Startup Opportunities</strong> – Access
                  to funding, mentorship, and internships.
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-footerBgColor p-8 rounded-lg shadow-md mb-12">
          <h3 className="text-2xl font-bold text-white mb-4">
            Event Timeline ⏳
          </h3>
          <div className="flex flex-wrap">
            <div className="w-full md:w-1/2 lg:w-1/5 mb-6 md:mb-0">
              <div className="border-l-4 border-headStrong pl-4 h-full">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          <div className="bg-footerBgColor p-8 rounded-lg shadow-md">
            <h3 className="text-2xl font-bold text-white mb-4">
              Domain Explanation Sessions 📅
            </h3>
            <div className="mb-6">
        ...
        <div className="mt-16 text-center">
          <p className="text-lg text-gray-300 mb-6 italic">
            GDG Innohacks 2K25 was just the beginning. Join us in 2K26 and
